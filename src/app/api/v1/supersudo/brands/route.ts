...
export async function POST(req: NextRequest) {
  try {
    ...
    logger.devLog("📤 [ADMIN BRANDS] POST request:", body);

    const result = await adminService.createBrand(body);
    logger.devLog("✅ [ADMIN BRANDS] Brand created:", result.data.id);
