...
/**
 * PATCH /api/v1/supersudo/attributes/[id]/values/[valueId]
...
export async function PATCH(
  ...
  try {
    ...
    logger.devLog('✏️ [ADMIN ATTRIBUTE VALUES] PATCH request:', { attributeId, valueId, body });
...
/**
 * DELETE /api/v1/supersudo/attributes/[id]/values/[valueId]
