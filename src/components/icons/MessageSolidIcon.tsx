...
export function MessageSolidIcon({ className }: MessageSolidIconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path fill="currentColor" d={MESSAGE_SOLID_PATH} />
    </svg>
  );
}
