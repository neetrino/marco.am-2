  ...
  return (
    <div className="relative mb-6 overflow-hidden rounded-[13px] bg-gradient-to-b from-[rgba(255,202,3,0.45)] to-[#fff9e5] p-5 pb-6 md:mb-5 md:p-6">
      ...
      <Link
        href={href}
        onClick={onNavigate}
        className={`${headerCategoryNavFont.className} inline-flex w-auto max-w-full items-center gap-2 self-start rounded-[68px] bg-marco-yellow py-2 pl-4 pr-1.5 text-sm font-bold text-marco-black transition-[filter] hover:brightness-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-marco-black/20 sm:gap-2.5 sm:pl-5 sm:pr-2 sm:text-base`}
      >
        <span className="min-w-0 whitespace-nowrap">{ctaLabel}</span>
        <span
